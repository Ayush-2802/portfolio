    ...
    2815: function (t, e, r) {
      ...
      var n,
        ...
        z = function t(e, r) {
          ...
          if (e in g && i) {
            if (((this.tfm = this.tfm || {}), "transform" === e))
              return w.transform.split(",").forEach(function (e) {
                return t.call(n, e, r);
              });
            if (
              (~(e = w[e] || e).indexOf(",")
        ...
        N = function () {
          ...
          if (this.tfm) {
            ...
            i.svg &&
              ...
              ((t = c()) && t.isStart) || s[X] || (W(s), (i.uncache = 1));
          }
        },
        I = function (t, e) {
          var r = { target: t, props: [], revert: N, save: z };
          return (
            t._gsap || u.p8.core.getCache(t),
            e &&
              e.split(",").forEach(function (t) {
                return r.save(t);
              }),
        ...
        V = function t(e, r, n) {
          ...
          return (
            s[r] ||
            s.getPropertyValue(r.replace(y, "-$1").toLowerCase()) ||
            ...
            e in g && e !== E && (e = X),
              r.removeProperty
                ? (("ms" === e.substr(0, 2) || "webkit" === e.substr(0, 6)) &&
                    (e = "-" + e),
                  r.removeProperty(e.replace(y, "-$1").toLowerCase()))
                : r.removeAttribute(e);
          }
        },
        ...
        Q = function t(e, r, n, s) {
          var i,
            ...
            b = "px" === s,
            w = "%" === s;
          return s === h || !c || J[s] || J[h]
            ? c
            : ("px" === h || b || (c = t(e, r, n, "px")),
              (f = e.getCTM && $(e)),
              (w || "%" === h) && (g[r] || ~r.indexOf("adius")))
            ? ((i = f ? e.getBBox()[m ? "width" : "height"] : e[y]),
              (0, u.Pr)(w ? (c / i) * 100 : (c / 100) * i))
            : ((d[m ? "width" : "height"] = 100 + (b ? h : s)),
              (o =
                ~r.indexOf("adius") || ("em" === s && e.appendChild && !x)
                  ? e
                  : e.parentNode),
              f && (o = (e.ownerSVGElement || {}).parentNode),
            ...
            : ((w || "%" === h) &&
              ...
              m &&
                w &&
                (((p = (0, u.DY)(o)).time = u.xr.time), (p.width = o[y])),
              (0, u.Pr)(b ? (i * c) / 100 : i && c ? (100 / i) * c : 0));
        },
        tt = function (t, e, r, n) {
          var s;
          return (
            ...
            g[e] && "transform" !== e
              ...
              : (!(s = t.style[e]) ||
                ...
                (s =
                  ...
                  (0, u.Ok)(t, e) ||
                  ("opacity" === e ? 1 : 0)),
            r && !~(s + "").trim().indexOf(" ") ? Q(t, e, s, r) + r : s
          );
        },
        te = function (t, e, r, n) {
          if (!r || "none" === r) {
          ...
          var a,
            ...
            m,
            x,
            y = new u.Fo(this._pt, t.style, e, 0, 1, u.Ks),
            v = 0,
            b = 0;
          if (
            ((y.b = r),
            ...
            (r += ""),
            "auto" == (n += "") &&
              ((t.style[e] = n), (n = V(t, e) || n), (t.style[e] = r)),
            (a = [r, n]),
            (0, u.kr)(a),
            (r = a[0]),
            (n = a[1]),
            ...
            for (; (o = u.d4.exec(n)); )
              (h = o[0]),
                ...
                h !== (c = p[b++] || "") &&
                  ((l = parseFloat(c) || 0),
                  (x = c.substr((l + "").length)),
                  "=" === h.charAt(1) && (h = (0, u.cy)(l, h) + x),
                  (g = parseFloat(h)),
                  (m = h.substr((g + "").length)),
                  (v = u.d4.lastIndex - m.length),
                  m ||
                    ((m = m || u.Fc.units[e] || x),
          ...
          if (e.tween && e.tween._time === e.tween._dur) {
            ...
            if ("all" === o || !0 === o) (a.cssText = ""), (n = 1);
              ...
              for (s = (o = o.split(",")).length; --s > -1; )
                g[(r = o[s])] &&
                  ((n = 1), (r = "transformOrigin" === r ? E : X)),
                  H(i, r);
            n &&
              (H(i, X),
              p &&
                (p.svg && i.removeAttribute("transform"),
                th(i, 1),
                (p.uncache = 1),
                W(a)));
          }
          ...
          return a.svg && t.getAttribute("transform")
            ...
            : (l !== ta ||
                ...
                ((r = t.parentNode) && t.offsetParent) ||
                  ((i = 1), (n = t.nextElementSibling), o.appendChild(t)),
                (l = tl(t)),
                s ? (p.display = s) : H(t, "display"),
                i &&
                  (n
                    ? r.insertBefore(t, n)
                    : r
        ...
        tc = function (t, e, r, n, s, i) {
          ...
          r
            ? c !== ta &&
              (o = m * v - x * y) &&
              ((p = _ * (v / o) + P * (-y / o) + (y * w - v * b) / o),
              (l = _ * (-x / o) + P * (m / o) - (m * w - x * b) / o),
              (_ = p),
              (P = l))
            : ((_ =
                (a = R(t)).x + (~O[0].indexOf("%") ? (_ / 100) * a.width : _)),
              (P =
                a.y +
            ...
            n || (!1 !== n && f.smooth)
              ? ((b = _ - h),
                (w = P - u),
                (f.xOffset = g + (b * m + w * y) - b),
                (f.yOffset = d + (b * x + w * v) - w))
            ...
            i &&
              (U(i, f, "xOrigin", h, _),
              U(i, f, "yOrigin", u, P),
              U(i, f, "xOffset", g, f.xOffset),
              U(i, f, "yOffset", d, f.yOffset)),
        ...
        th = function (t, e) {
          ...
          return (
            ...
            r.svg &&
              ...
              tc(t, Y || Z, !!Y || r.originIsAbsolute, !1 !== r.smooth, w)),
            (v = r.xOrigin || 0),
            (b = r.yOrigin || 0),
            w !== ta &&
              ((M = w[0]),
              ...
              6 === w.length
                ? ((a = Math.sqrt(M * M + F * F)),
                  ...
                  (p = M || F ? x(F, M) * d : 0),
                  (c = C || S ? x(C, S) * d + p : 0) &&
                    (o *= Math.abs(Math.cos(c * m))),
                  r.svg &&
                    ((n -= v - (v * M + b * C)), (s -= b - (v * F + b * S))))
                : ((q = w[6]),
                  (I = w[7]),
                  (z = w[8]),
                  (W = w[9]),
                  ...
                  (l = (O = x(q, N)) * d),
                  O &&
                    ((Y = A * (_ = Math.cos(-O)) + z * (P = Math.sin(-O))),
                    (T = B * _ + W * P),
                    (k = q * _ + N * P),
                    (z = -(A * P) + z * _),
                    (W = -(B * P) + W * _),
                  ...
                  (f = (O = x(-C, N)) * d),
                  O &&
                    ((Y = M * (_ = Math.cos(-O)) - z * (P = Math.sin(-O))),
                    (T = F * _ - W * P),
                    (k = C * _ - N * P),
                    (D = S * P + D * _),
                    (M = Y),
                  ...
                  (p = (O = x(F, M)) * d),
                  O &&
                    ((Y = M * (_ = Math.cos(O)) + F * (P = Math.sin(O))),
                    (T = A * _ + B * P),
                    (F = F * _ - M * P),
                    (B = B * _ - A * P),
                    (M = Y),
                    (A = T)),
                  l &&
                    Math.abs(l) + Math.abs(p) > 359.9 &&
                    ((l = p = 0), (f = 180 - f)),
                  (a = (0, u.Pr)(Math.sqrt(M * M + F * F + C * C))),
                  (o = (0, u.Pr)(Math.sqrt(B * B + q * q))),
                  (c = Math.abs((O = x(A, B))) > 2e-4 ? O * d : 0),
                  (y = D ? 1 / (D < 0 ? -D : D) : 0)),
              r.svg &&
                ((Y = t.getAttribute("transform")),
                (r.forceCSS = t.setAttribute("transform", "") || !tp(V(t, X))),
            ...
            (r.scaleX = (0, u.Pr)(a)),
            (r.scaleY = (0, u.Pr)(o)),
            (r.rotation = (0, u.Pr)(p) + "deg"),
            (r.rotationX = (0, u.Pr)(l) + "deg"),
            (r.rotationY = (0, u.Pr)(f) + "deg"),
            (r.skewX = c + "deg"),
            (r.skewY = g + "deg"),
            (r.transformPerspective = y + "px"),
            (r.zOrigin = parseFloat(Z.split(" ")[2]) || 0) && (G[E] = tu(Z)),
            (r.xOffset = r.yOffset = 0),
            (r.force3D = u.Fc.force3D),
            (r.renderTransform = r.svg ? ty : h ? tx : td),
            (r.uncache = 0),
            r
          );
        },
        ...
        tg = function (t, e, r) {
          var n = (0, u.Wy)(e);
          return (
            (0, u.Pr)(parseFloat(e) + parseFloat(Q(t, "x", r + "px", n))) + n
          );
        },
        td = function (t, e) {
          (e.z = "0px"),
        ...
        tx = function (t, e) {
          ...
          if (v && (f !== tm || l !== tm)) {
            var O,
              ...
              P = Math.sin(_),
              M = Math.cos(_);
            (i = tg(y, i, -(P * (O = Math.cos((_ = parseFloat(f) * m))) * v))),
              (a = tg(y, a, -(-Math.sin(_) * v))),
              (o = tg(y, o, -(M * O * v) + v));
          }
        ...
        ty = function (t, e) {
          ...
          (h = parseFloat(h)),
            (g = parseFloat(g)),
            (d = parseFloat(d)) && ((g += d = parseFloat(d)), (h += d)),
            h || g
              ? ((h *= m),
                (g *= m),
                (r = Math.cos(h) * x),
                ...
                g &&
                  ((d *= m),
                  (s *= a = Math.sqrt(1 + (a = Math.tan(g - d)) * a)),
                  (i *= a),
                  d &&
            ...
            ((M && !~(f + "").indexOf("px")) ||
              (F && !~(c + "").indexOf("px"))) &&
              ((M = Q(v, "x", f, "px")), (F = Q(v, "y", c, "px"))),
            (b || w || O || _) &&
              ((M = (0, u.Pr)(M + b - (b * r + w * s) + O)),
              (F = (0, u.Pr)(F + w - (b * n + w * i) + _))),
            (p || l) &&
              ((a = v.getBBox()),
              (M = (0, u.Pr)(M + (p / 100) * a.width)),
              (F = (0, u.Pr)(F + (l / 100) * a.height))),
            (a =
              "matrix(" +
              r +
              "," +
            ...
            o &&
              ...
              "cw" === i && p < 0
                ...
                : "ccw" === i &&
                  p > 0 &&
                  (p = ((p - 36e9) % 360) - 360 * ~~(p / 360))),
            (t._pt = a = new u.Fo(t._pt, e, r, n, p, _)),
            (a.e = l),
            (a.u = "deg"),
            t._props.push(r),
            a
            ...
            (i = f[s]) !== (a = n[s]) &&
              ...
              ((o =
                (0, u.Wy)(i) !== (l = (0, u.Wy)(a))
                  ...
                  : parseFloat(i)),
              (p = parseFloat(a)),
              (t._pt = new u.Fo(t._pt, n, s, o, p - o, O)),
              (t._pt.u = l || 0),
              t._props.push(s));
          tb(n, f);
        };
      ...
      var tO = {
        ...
        init: function (t, e, r, n, s) {
          ...
          e))
            if (
              "autoRound" !== h &&
              ((a = e[h]), !(u.$i[h] && (0, u.if)(h, e, r, n, t, s)))
            ) {
              if (
                ((f = typeof a),
                (c = ti[h]),
                "function" === f && (f = typeof (a = a.call(r, n, t, s))),
                "string" === f && ~a.indexOf("random(") && (a = (0, u.UI)(a)),
                c)
              )
                c(this, t, h, a, r) && (C = 1);
              else if ("--" === h.substr(0, 2))
                (i = (getComputedStyle(t).getPropertyValue(h) + "").trim()),
                  (a += ""),
                  (u.GN.lastIndex = 0),
                  u.GN.test(i) || ((d = (0, u.Wy)(i)), (m = (0, u.Wy)(a))),
                  m ? d !== m && (i = Q(t, h, i, m) + m) : d && (a += d),
                  this.add(B, "setProperty", i, a, n, s, 0, 0, h),
                  A.push(h),
                  S.push(h, 0, B[h]);
              else if ("undefined" !== f) {
                if (
                  ...
                  if (
                    ...
                    (this._pt = new u.Fo(
                      ...
                      "scaleY",
                      _.scaleY,
                      (x ? (0, u.cy)(_.scaleY, x + o) : o) - _.scaleY || 0,
                      O
                    )),
                      (this._pt.u = 0),
                      A.push("scaleY", h),
                    ...
                    S.push(E, 0, B[E]),
                      ...
                      _.svg
                        ...
                        : ((m = parseFloat(a.split(" ")[2]) || 0) !==
                            _.zOrigin && U(this, _, "zOrigin", _.zOrigin, m),
                          U(this, B, h, tu(i), tu(a)));
                    continue;
                  } else if ("svgOrigin" === h) {
                    tc(t, a, 1, F, 0, this);
                    continue;
                ...
                if (
                  y ||
                  ((o || 0 === o) && (l || 0 === l) && !b.test(a) && h in B)
                )
                  (d = (i + "").substr((l + "").length)),
                    o || (o = 0),
                    (m = (0, u.Wy)(a) || (h in u.Fc.units ? u.Fc.units[h] : d)),
                    d !== m && (l = Q(t, h, i, m)),
                    (this._pt = new u.Fo(
                      this._pt,
                      y ? _ : B,
                ...
                y || (h in B ? S.push(h, 0, B[h]) : S.push(h, 1, i || t[h])),
                  A.push(h);
              }
            }
          C && (0, u.JV)(this);
        ...
        getSetter: function (t, e, r) {
          ...
          return (
            n && 0 > n.indexOf(",") && (e = n),
            e in g && e !== E && (t._gsap.x || tt(t, "x"))
              ? r && f === r
                ? "scale" === e
                  ? Y
                  : B
                : ((f = r || {}), "scale" === e ? T : k)
              : t.style && !(0, u.m2)(t.style[e])
              ? S
              : ~e.indexOf("-")
              ? A
              : (0, u.S5)(t, e)
        ...
        core: { _removeProperty: H, _getMatrix: tf },
      };
      (u.p8.utils.checkPrefix = G),
        (u.p8.core.getStyleSaver = I),
